				...
				if (maps != null) {
					...
					if (players != null) {
						...
						if (numTurns > 0) {
							...
							JOptionPane.showMessageDialog(null, "Number of turns must be number between 10 and 50",
									"Warning", JOptionPane.WARNING_MESSAGE);
						}
					} else {
						JOptionPane.showMessageDialog(null, "Select 2 Players atleast", "Warning",
