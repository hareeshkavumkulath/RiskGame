...
/**
 * Map Upload Window for the user to upload .map file. It validates and prints
 * the map.
 * 
 * @author Anqi Wang
 * @version 1.1
	...
	public void initialize() {
		...
		uploadButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				if (file == null) {
					...
					JOptionPane.showMessageDialog(new JFrame(), message, "No File Selected", JOptionPane.ERROR_MESSAGE);
		...
		continentsJList.addListSelectionListener(new ListSelectionListener() {
			...
			public void valueChanged(ListSelectionEvent listSelectionEvent) {
				...
				ArrayList<Territory> territories = mapMessage.getMap().getContinents().get(selections[0])
						.getTerritories();
